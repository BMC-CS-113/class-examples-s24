...
public class BankAccount {
    ...
    //TODO 1: fill out equals
    public boolean equals(Object obj) {
        return this.accountNum == ((BankAccount) obj).getAccountNum();
    }

    //TODO 2: test it in main
    public static void main(String[] args) {
        BankAccount account = new BankAccount(1, "savings", "Elizabeth");
        BankAccount account2 = new BankAccount(2, "checking", "Dianna");
